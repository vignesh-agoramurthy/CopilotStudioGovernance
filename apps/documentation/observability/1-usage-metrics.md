...
1. Open **Usage**.
1. Select the relevant Microsoft 365 Copilot or agent usage report.
1. Review user licence, enabled user, or usage information where available.
...
1. Navigate to the security groups used to manage Copilot Studio access.
1. Review group membership.
1. Validate whether users are enabled through assigned security groups.
...
1. Select **Agents**.
1. Review active user activity for the selected reporting period.
...
1. Select **Microsoft 365 Copilot**.
1. Select **Agents**.
1. Compare usage across the available reporting periods.\
...
1. Review Copilot Studio metrics and recommendations.
...
1. Navigate to **Agent Inventory**.
1. Review the list of agents created across available environments.
1. Use reporting views or Power BI dashboards to aggregate agent counts.\
...
1. Review session and conversation performance data.

#### Option 2: Copilot Studio Kit

1. Open Copilot Studio Kit.
1. Navigate to **Conversation KPIs**, where configured.
1. Review conversation or session-level metrics.
...
1. Compare against usage, sessions, or active user activity.
1. Classify agents as active where they show usage within the reporting period.
...
1. Select **Microsoft 365 Copilot**.
1. Select **Agents**.
1. Review agent usage and active user information.\
...
1. Navigate to **Monitor**.
1. Under **Products**, select **Copilot Studio**.
1. Review Copilot Studio metrics.
...
1. Select **Microsoft 365 Copilot**.
1. Select **Agents**.
1. Review user and agent usage information.
...
1. Select the relevant agent.
1. Navigate to **Analytics**.
1. Review themes, topics, unanswered questions, or other available insight areas.\
