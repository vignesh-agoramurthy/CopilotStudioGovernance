...
2.  Navigate to the relevant agent reporting or agent management area.
3.  Review agents with exceptions, failures, or issue indicators where available.\
...
3.  Navigate to analytics or satisfaction reporting.
4.  Review available CSAT results, where configured.
...
4.  Review session or conversation metrics.

**Option 2: Copilot Studio Kit**

1.  Open Copilot Studio Kit.
2.  Navigate to the **Conversation KPI** dashboard, where configured.
3.  Review turn count by conversation or reporting period.\
...
2.  Select the relevant agent.
3.  Navigate to **Analytics**.
4.  Review session or conversation duration.
...
1.  Open Copilot Studio Kit.
2.  Navigate to **Conversation KPIs** or relevant KPI views, where configured.
