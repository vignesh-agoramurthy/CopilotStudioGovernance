...
2.  Navigate to **Agent Value** or **Agent Value Summary**.
3.  Review AI prompt-driven or agent-level time savings.

**Option 2: Copilot Studio**

1.  Open Copilot Studio.
2.  Navigate to the relevant agent.
3.  Review savings where configured by the maker.
...
1.  Open Copilot Studio Kit.
2.  Navigate to **Agent Value** or **Agent Value Summary**.
3.  Review estimated value or cost savings.
...
1.  Open Copilot Studio.
2.  Navigate to the relevant agent.
3.  Review savings where configured.
...
5.  Select **Agents**.
6.  Review user and agent activity over the available reporting periods.
...
3.  Review abandoned conversation metrics where available.
4.  Validate results against agent configuration.\
...
2.  Open Copilot Studio Kit.
3.  Review available agent and usage data by environment.
4.  Use a custom Power BI dashboard to map environments or agents to business units.
