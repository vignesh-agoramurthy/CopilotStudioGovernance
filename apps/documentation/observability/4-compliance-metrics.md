...
1. Review compliance cases.
1. Filter by status, policy type, owner, environment, or agent where available.\
...
1. Open **All agents**.
1. Review ownership information where available.\
    ![Observability screenshot](./assets/media/image21.png)

#### Option 2: Copilot Studio Kit

1. Open Copilot Studio Kit.
1. Navigate to **Compliance Hub** or **Agent Inventory**.
1. Review agents missing ownership information.\
...
1. Review authentication type for each agent.
1. Filter or group agents by authentication method.\
...
1. Open Copilot Studio Kit.
1. Navigate to **Agent Inventory**.
1. Review connection details for each agent.
1. Identify agents connected to sensitive or high-risk systems.
...
1. Open Copilot Studio Kit.
1. Navigate to **Agent Inventory**.
1. Review AI prompt usage by agent.
1. Identify agents using AI prompts for further governance review where required.
...
1. Open Copilot Studio Kit.
1. Navigate to **Agent Inventory**.
1. Review knowledge sources associated with each agent.
1. Validate whether sources are appropriate, current, and approved.\
...
1. Navigate to **Agents**.
1. Open **All agents**.
1. Filter or review agents by availability, deployment, or channel information where available.\
